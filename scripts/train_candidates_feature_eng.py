...
if __name__ == "__main__":
    ...
    # This script is for feature-engineering experiments (non-linear transforms / interactions).
    # It writes artifacts with the label `_fe` to avoid overwriting the demo artifacts.
